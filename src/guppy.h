...
bool         gup_set_cstr_has(GupSetCstr set, const char *x);
void         gup_set_cstr_add(GupSetCstr *set, const char *x);
void         gup_set_cstr_remove(GupSetCstr *set, const char *x);
